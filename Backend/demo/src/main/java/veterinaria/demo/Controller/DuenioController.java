...
import veterinaria.demo.Service.DueniosService;
...
public class DuenioController {
    ...
    public ResponseEntity<?> create(@RequestBody Duenio duenio) {
        return ResponseEntity.status(HttpStatus.CREATED).body(dueniosService.saveDuenio(duenio));
    }
     ...
     * }
     * 
     * @PostMapping(value = "/agregarDuenio", consumes =
